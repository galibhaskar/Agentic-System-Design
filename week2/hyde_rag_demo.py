...
from agents import HyDERAGAgent
...
def build_hyde_rag():
    ...
    # 4. Build HyDE RAG agent
    print("Building HyDE RAG agent...")
    agent_wrapper = HyDERAGAgent(retriever_tools=retriever_tools)
...
if __name__ == "__main__":
    agent, agent_wrapper = build_hyde_rag()
    print("HyDE RAG ready. The router will pick the right retriever per hypothetical document generated using query.")
